      ...
      <form method="post" enctype="multipart/form-data">
        <div class="car-body">
          <div class="row p-3">
            ...
            <div class="col-4 text-center">
              <span style="display: block; font-size: 16px">Documento Tributario Electrónico</span>
              <b style="display: block; font-size: 20px">Factura Electrónica</b>
              <div class="row">
                <div class="col-3"></div>
                <div class="col-6">
                  <?php
                    ...
                    $respuestaVenta = VentasController::ctrMostrarVentasSinFecha($itemVenta, $valorVenta);

                    if(!$respuestaVenta){
                      echo '<input type="text" class="form-control" name="noFactura" value="10001" readonly>';
                    }else{
                      foreach ($respuestaVenta as $key => $value) {
                        
                      }
                      $codigo = $value["noFactura"];
                      echo '<input type="text" class="form-control" name="noFactura" value="'.($codigo + 1).'" readonly>';
                    }
            ...
            <div class="col-6">
            <span style="display:block" class="d-flex mb-1"><b class="col-4">Cargar XML: </b> <input type="file" name="xml" id="cargarXML" required accept=".xml"></span>
            </div>
            <div class="col-6"></div>
            <div class="col-6">
              <span style="display:block" class="d-flex mb-1"><b class="col-4">UUID: </b> <input readonly class="form-control form-control-sm " type="text" name="uuidVenta" id="uuidVenta" placeholder="Número de autorización" required></span>
            </div>
            <div class="col-6">
            <span style="display:block" class="d-flex mb-1"><b class="col-4">Serie: </b> <input readonly class="form-control form-control-sm" type="text" name="serieVenta" id="serieVenta" placeholder="Número de serie" required>
            <input name="idClientePedido" type="hidden" class="idClienteCotizacion"></span>
            </div>
            <div class="col-6">
              <span style="display:block" class="d-flex mb-1"><b class="col-4">No. de Factura: </b> <input readonly placeholder="Número de factura" class="form-control form-control-sm " type="text" name="noFacturaSat" id="noFacturaSat" required></span>
            </div>
            <div class="col-6">
              <span style="display:block" class="d-flex mb-1"><b class="col-4">Fecha de certificación: </b> <input readonly class="form-control form-control-sm " placeholder="Fecha de certificación" type="text" name="fechaVenta" id="fechaVenta"></span>
            </div>
            <div class="col-12">
                <br>
            </div>
            <div class="col-4">
              <span style="display:block" class="d-flex mb-1"><b>NIT: </b> <input class="form-control form-control-sm  nitCliente" type="text" name="nitClienteVenta" placeholder="Ingrese el nit" >
            ...
            <div class="col-4">
            <span style="display:block" class="d-flex mb-1"><b>Nombre: </b> <input class="form-control form-control-sm nombreCliente" type="text" name="nombreCliente" placeholder="Nombre del cliente" >
            <input name="idClienteVenta" type="hidden" class="idClienteCotizacion"></span>
            </div>
            <div class="col-4">
            ...
            <div class="col-3">
              ...
              <span style="display:block" class="d-flex mb-1"><input type="hidden" name="idVendedorVenta" value="<?php echo $_SESSION["id"] ?>"></span>
            </div> 
            <div class="col-12">
              <br>
            </div>
            ...
            <div class="col-4">
              ...
              <textarea name="comentarioVenta" id="comentarioCotizacion" class="form-control" rows="3" ></textarea>
            </div>
            <div class="col-4"></div>
            <div class="col-4">
              ...
              <div class="d-flex pb-1">
                ...
                <input type="number" name="envioVenta" id="envioCotizacion" class="form-control form-control-sm">
              </div>
              <div class="d-flex pb-1">
                <b class="col-4">Total</b>
                <input type="text" id="totalCotizacion" name="totalVenta" readonly class="form-control form-control-sm" required>
              </div>
              <div class="d-flex pb-1">
                <b class="col-4">Método de Pago</b>
                <select id="metodoPagoCotizacion" name="metodoPagoVenta" class="form-control form-control-sm" required>
            ...
            <div class="col-4"></div>
            <div class="col-4">
              <button type="submit" class="btn btn-success float-right" disabled id="btnGuardarCotizacion"><i class="fas fa-save"></i> Guardar Venta</button>
            </div>
          </div>
        </div>
        <?php
        
          $crearPedido = new VentasController();
          $crearPedido -> ctrInsertarVenta();
