  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <a href="crearventas" class="btn btn-default">
              ...
              foreach ($respuesta as $key => $value) {
                ...
                echo '
                  <tr>
                    ...
                    <td>'.$estatus.'</td>
                    <td>
                      <button class="btn btn-xs btn-info btnImprimirVenta" idVenta="'.$value["noFactura"].'"><i class="fas fa-print"></i></button>';
                    if($_SESSION["perfil"] == 1){if($value["estatus"] == 1){
                      echo ' <button class="btn btn-xs btn-danger btnEliminarVenta" idVenta="'.$value["idVenta"].'"><i class="fas fa-trash"></i></button>';
                    }}
                    echo '</td>
                  </tr>
                ';
